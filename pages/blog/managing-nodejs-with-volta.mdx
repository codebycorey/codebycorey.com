...
brief: "I recently wrote a blog post about how I use NVM to manage my node version. Someone commented on the post saying I should look into Volta\nWhat is Volta\nVolta is a command line tool used to manage your Node.js. It is built using Rust and is shipped as..."
date: '2020-09-11T13:07:06.896Z'
---

I recently wrote a blog post about how I use NVM to [manage my node version](https://blog.coreyodonnell.tech/managing-my-node-versions). Someone commented on the post saying I should look into [Volta](https://volta.sh/)
...
- Previous post about using [NVM to manage node version](https://blog.coreyodonnell.tech/managing-my-node-versions)
