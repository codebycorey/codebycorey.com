...
brief: "On my Next.js project, I wanted to add some authentication. I decided to use Firebase for my user management and data store.\nWhat I needed:\n\nOAuth using Twitter\nclient-side authentication\nProtected pages\nserver-side authentication\n\n\nAssumptions: You ..."
...
- Nest.js [Docs](https://nextjs.org/docs/getting-started)
