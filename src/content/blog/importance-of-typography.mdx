...
import typoJustify from '../../assets/images/importance-of-typography/typo-justify.png';
import typoContrast from '../../assets/images/importance-of-typography/typo-contrast.png';
import typoMultiples from '../../assets/images/importance-of-typography/typo-multiples.png';
...
1.  Try to always use **justify left**.
    ...
    <Image src={typoJustify} alt="Left, Center, Forced Justify" />
...
4.  When choosing font weights, always skip a level. `fine/medium`, `light/bold`, `medium/extra-bold`
    ...
    <Image src={typoContrast} alt="Typography with different font weight" />

5.  Always use multiples when choosing sizes for fonts and rules. `2x/4x`, `2x/8x`, `4x/8x`

    <Image src={typoMultiples} alt="Typography with font sizes based on multiples" />
