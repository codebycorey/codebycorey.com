...
import fontShift from '../../assets/images/defeating-flash-of-unstyled-text-fout/font-shift.gif';
import noFontShift from '../../assets/images/defeating-flash-of-unstyled-text-fout/no-font-shift.gif';
...
<img src={fontShift.src} width={fontShift.width} height={fontShift.height} alt="Font shifting as it loads" loading="lazy" />
...
<img src={noFontShift.src} width={noFontShift.width} height={noFontShift.height} alt="Font loads without shift" loading="lazy" />
