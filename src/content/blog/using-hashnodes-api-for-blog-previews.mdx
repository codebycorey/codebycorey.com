...
import hashnodeBlogPreview from '../../assets/images/using-hashnodes-api-for-blog-previews/hashnode_api_blog_preview.png';
...
<Image src={hashnodeBlogPreview} alt="Blog post previews based on hashnode api" />
