...
export default function Hero() {
    return (
      <div style={{ background: 'linear-gradient(70deg, #3d6a3d 0%, #7aa77a 100%)' }}>
        <div className="pt-24">
          <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-around justify-around text-gray-100">
            <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
              <h1 className="my-4 text-5xl font-bold leading-tight">Corey O'Donnell</h1>
              <p className="leading-tight text-2xl w-full mb-8">
                Full-Stack Web Developer <br /> React | TypeScript | Python
              </p>
              <p className="leading-tight text-xl mb-8 text-gray-200">
              ...
              <div className="flex">
                <a
                  className="w-16 h-16 mr-4 rounded-full border-2 border-white flex justify-center items-center"
                  target="_blank"
                ...
                >
                  <svg className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" role="img">
                    <title>dev.to</title>
            ...
            <div className="w-full md:w-3/5 py-6 text-center flex justify-end">
              <img className="w-full md:w-4/5 z-50" src="/guy-desk.svg" />
            </div>
          </div>
