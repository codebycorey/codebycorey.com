...
export default function Hero() {
    return (
      <div className="pb-12 bg-gray-800 md:h-screen">
        <div className="px-3 h-full mx-auto flex flex-wrap flex-row items-center justify-center text-gray-100">
          <div className="flex flex-col w-full lg:w-3/12 justify-center items-start text-center lg:text-left">
            <h1 className="mx-auto my-4 text-5xl text-center font-bold leading-tight">Corey O'Donnell</h1>
            <p className="mx-auto text-center leading-tight text-2xl lg:text-2xl mb-8">
              Full-Stack Web Developer <br /> React | TypeScript | Python
            </p>
            <p className="mx-auto w-full md:w-10/12 text-center leading-tight text-xl lg:text-1xl mb-8 text-gray-200">
            ...
            <div className="flex mx-auto text-green-500">
              <a
                className="w-12 h-12 mr-4 rounded-full border-2 border-green-500 flex justify-center items-center"
                target="_blank"
              ...
              <a
                className="w-12 h-12 rounded-full border-2 border-green-500 flex justify-center items-center"
                target="_blank"
                rel="noopener noreferrer nofollow"
