    ...
    <footer className="text-gray-200 bg-gray-900">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        <div className="flex justify-center space-x-6 md:order-2">
          <a href="https://twitter.com/CodeByCorey" className="text-gray-400 hover:text-gray-500" target="_blank" rel="noopener noreferrer nofollow">
          ...
          <a href="https://github.com/CodeByCorey" className="text-gray-400 hover:text-gray-500" target="_blank" rel="noopener noreferrer nofollow">
          ...
          <a href="https://blog.codebycorey.com" className="text-gray-400 hover:text-gray-500" target="_blank" rel="noopener noreferrer nofollow">
            <span className="sr-only">HashNode</span>
            <svg className="h-6 w-6" width="337" height="337" viewBox="0 0 337 337" fill="none">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
          ...
          <a href="https://dev.to/CodeByCorey" className="text-gray-400 hover:text-gray-500" target="_blank" rel="noopener noreferrer nofollow">
          ...
          <a href="mailto:me@coreyodonnell.com" className="text-gray-400 hover:text-gray-500" target="_blank" rel="noopener noreferrer nofollow">
        ...
        <div className="mt-8 md:mt-0 md:order-1">
          <p className="text-center text-base text-gray-400">&copy; 2020 Corey O'Donnell</p>
        </div>
      </div>
    </footer>
  );
