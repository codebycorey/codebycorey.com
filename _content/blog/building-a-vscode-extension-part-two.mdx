...
brief: "Now that I have an idea of what I am going to build, It's time to set up the repository. VSCode has a straightforward method for bootstrapping a new extension."
...
_Disclaimer: I develop on Linux, so I will be using those commands._
